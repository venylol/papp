...
- [完整 Release ZIP](https://github.com/venylol/papp/releases/download/v2026.09.13/PAPP-Offline-20260913-public.zip)：上述文件，加上 `runtime/python/`、`data/reference/` 和以下大型模型数据文件：
